      ...
      <SideNav.Nav defaultSelected="home">
        <NavItem eventKey="home" onClick={() => handleClick('/home')}>
          ...
          <NavText style={{ fontSize: '1.5em' }}>
            <Link to="/Home" style={{ textDecoration: 'none', color: 'white', userSelect:"none"  }}>
              Inicio
            </Link>
          </NavText>
        </NavItem>
        <NavItem eventKey="programas" style={{backgroundColor:""}}>
          ...
          <NavItem eventKey="tecnico"  onClick={() => handleClick('/SchedulingTechnical')}>
            <NavText style={{ fontSize: "1.2em", userSelect:"none"  }} eventKey="tecnico"><Link to="/SchedulingTechnical" style={linkStyles}>Tecnico</Link></NavText>
          </NavItem>
          <NavItem eventKey="tecnologo" onClick={() => handleClick('/SchedulingTechnological')}>
        ...
        <NavItem eventKey="instructores">
          ...
          <NavItem eventKey="FullTimeInstructor">
            <NavText style={{ fontSize: "1.2em", outline: "none"}} eventKey="planta" onClick={() => handleClick('/CrudAppFullTimeInstructor')}>
              <Link to="/CrudAppFullTimeInstructor" style={{ textDecoration: "none", color:"black", userSelect:"none" }}>Planta</Link>
            </NavText>
          </NavItem>
          <NavItem eventKey="contrato" onClick={() => handleClick('/CrudApp')} style={{}}>
