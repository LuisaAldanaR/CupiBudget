...
import CrudTable from '../SchedulingAssistant/CrudTable';
...
const SchedulingAssistant = () => {
  ...
  const loadTableData = () => {
    let urlGet = "https://www.cupibudget.somee.com/api/TrainingProgram/ListMachinistOperatorInPerson";
  ...
  const loadTableDataVirtual = () => {
    ...
    return (  
        <div className='content'>
            <h1 className='h3Table'>Operarios presenciales</h1>
